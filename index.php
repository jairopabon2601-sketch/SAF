<?php
  ...
  session_start();
  renovar_sesion(); // Renovar la sesión para evitar que expire
  ...
  if (verificar_sesion_activa()) {
    ...
    if($codigo_formulario > 0) {
        if(!validar_acceso_formulario($codigo_formulario, $_SESSION['codigo_perfil'])) {
...
<head>
  ...
  <script type="text/javascript">
     <?php
        ...
        if($acceso_denegado){
          echo "var acceso_denegado=true;";
        }else{
          echo "var acceso_denegado=false;";
        }
      ?>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
        <div class="container-fluid" id="div_principal_form">
          <?php if($acceso_denegado): ?>
            <div class="alert alert-warning" role="alert">
              <h4 class="alert-heading">Acceso Denegado</h4>
              <p>No tiene permisos para acceder a este formulario. Por favor, contacte al administrador del sistema.</p>
              <hr>
              <p class="mb-0">Puede continuar navegando por el menú lateral.</p>
            </div>
          <?php endif; ?>
        </div>
        <!-- /.container-fluid -->
